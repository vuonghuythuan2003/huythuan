...
if(strlen($username) == 0) {$loi.="Chưa nhập tên đăng nhập<br>";}
if(strlen($username) <6) {$loi.="Tên đăng nhập quá ngắn<br>";}
if(strlen($password) < 6) {$loi.= "Mật khẩu quá ngắn<br>";}
if (strlen($fullname) ==0) {$loi.= "Chưa nhập họ tên<br>";}
if (strlen($email) <6 ) {$loi.= "Email nhập không đúng<br>";}
if (strlen($date) < 10) {$loi.= "Chưa nhập ngày sinh<br>";}
