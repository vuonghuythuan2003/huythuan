...
if (isset($_POST['user_score'])) {
    ...
    if ($checkResult->num_rows > 0) {
        ...
        $updateQuery = "UPDATE user_tests SET test1 = '$userScore - $depressionStatus', time_taken = NOW(), next_test_time = DATE_ADD(NOW(), INTERVAL 1 WEEK) WHERE id_name = '$userId'";
        ...
        $insertQuery = "INSERT INTO user_tests (id_name, username, fullname, test1, test2, test3, test4, time_taken, next_test_time) 
                        VALUES ('$userId', '$username', '$fullname', '$userScore - $depressionStatus', '0', '0', '0', NOW(), DATE_ADD(NOW(), INTERVAL 1 WEEK))";
