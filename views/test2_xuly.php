...
$kiemTraQuery = "SELECT id_name FROM test2 WHERE id_name = '$userId'";
...
if ($kiemTraResult->num_rows == 0) {
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $sqlTest2 = "INSERT INTO test2 (" . implode(", ", array_keys($valuesTest2)) . ") VALUES ('" . implode("', '", $valuesTest2) . "')";
